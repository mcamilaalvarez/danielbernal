...
const navigation = [
  { name: 'Inicio', href: '/' },
  { name: 'Quién es Daniel', href: '/presentation' },
  { name: 'Noticias Destacadas', href: '/news' },
  { name: 'Por Cundinamarca: hechos', href: '/achievements' },
  { name: 'Visión y Propuestas', href: '/proposals' },
  { name: 'Súmate al equipo D', href: '/join-team' },
  { name: 'Multimedia / Galería', href: '/gallery' },
