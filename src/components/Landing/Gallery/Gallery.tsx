...
const visionImages = [
    ...
    {
        id: 5,
        src: "/images/PorLaSeguridadTodo.jpg",
        alt: "Por la seguridad todo",
        title: "Por la seguridad todo",
        href: "/propuestas#seguridad"
    },
    {
        id: 6,
        src: "/images/danielComunidad.jpg",
        alt: "Autonomía y buen gobierno",
        title: "Autonomía y buen gobierno",
        href: "/propuestas#autonomia"
    },
];
...
export default function Gallery() {
    ...
    return (
        <section className="flex flex-col items-center bg-white py-16 pb-24 px-4 md:px-8 lg:px-16 w-full ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-8 items-start w-[90%] mx-auto">
                    ...
                    <div className="flex flex-col lg:col-span-2">
                        ...
                        <p className="text-lg md:text-xl text-gray-700 leading-relaxed font-helvetica font-light">
                            ...
                            <span className="font-bold font-helvetica">Mi visión se centra en seis ejes</span>
                        </p>
                    </div>
 ...
 {/*Imagen 2*/ }
                        ...
                        <div 
                            onClick={() => router.push(visionImages[4].href)}
                            className="relative rounded-xl overflow-hidden aspect-[4/3] sm:aspect-[4/3] col-span-1 sm:col-span-2 cursor-pointer group"
                        >
                            <Image
                                src={visionImages[4].src}
                                alt={visionImages[4].alt}
                                fill
                                className="object-cover transition-transform duration-300 group-hover:scale-105"
                            />
                           <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-4">
                                <h3 className="text-white text-[18px] sm:text-base lg:text-[20px] font-light text-center leading-[0.8] group-hover:text-[#f7ab13] transition-colors duration-300">
                                   <span className="font-bold text-[22px] sm:text-[26px]"> {visionImages[4].title}</span> <br></br> y sostenible
                                </h3>
                            </div>
                        </div>
                        <div 
                            onClick={() => router.push(visionImages[5].href)}
                            className="relative rounded-xl overflow-hidden aspect-[4/3] sm:aspect-auto col-span-1 sm:col-span-3 cursor-pointer group"
                        >
                            <Image
                                src={visionImages[5].src}
                                alt={visionImages[5].alt}
                                fill
                                className="object-cover transition-transform duration-300 group-hover:scale-105"
                            />
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-4">
                                <h3 className="text-white text-[20px] sm:text-[24px] lg:text-[26px] font-bold text-center leading-[0.8] group-hover:text-[#f7ab13] transition-colors duration-300">
                                    {visionImages[5].title}
                                </h3>
                            </div>
                        </div>
                    </div>
