...
const socialLinks = [
    { Icon: FacebookIcon, handle: "danielbernalfunza", url: "https://facebook.com/danielbernalfunza" },
    { Icon: XIcon, handle: "@DanielFBernalM", url: "https://x.com/DanielFBernalM" },
    { Icon: InstagramIcon, handle: "@danielbernalfunza", url: "https://instagram.com/danielbernalfunza" },
    { Icon: TikTokIcon, handle: "danielfelipeberna4", url: "https://tiktok.com/@danielfelipeberna4" },
];
...
export default function Footer() {
    ...
    return (
        <footer 
            className="relative w-full overflow-hidden font-helvetica bg-[#114380]"
          /*   style={{
        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-8 py-8">
                <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
                    ...
                    {/* Sección central - Vota a la Cámara */}
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-6 sm:gap-10">
                    {socialLinks.map((social, index) => (
                        ...
                        >
                            <social.Icon />
                            <span className="text-sm sm:text-base font-light">{social.handle}</span>
                        </a>
                    ))}
                </div>
            </div>
